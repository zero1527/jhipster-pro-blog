      ...
      .then(values => {
        ...
        if (that.resourceCategory.id) {
          this.resourceCategoryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.filesResourceCategory.updated', { param: param.data.id }).toString();
          ...
          this.resourceCategoryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.filesResourceCategory.created', { param: param.data.id }).toString();
