      ...
      .then(values => {
        ...
        if (that.viewPermission.id) {
          this.viewPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.systemViewPermission.updated', { param: param.data.id }).toString();
          ...
          this.viewPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.systemViewPermission.created', { param: param.data.id }).toString();
