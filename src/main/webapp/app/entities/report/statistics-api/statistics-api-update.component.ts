      ...
      .then(values => {
        ...
        if (that.statisticsApi.id) {
          this.statisticsApiService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.statisticsStatisticsApi.updated', { param: param.data.id }).toString();
          ...
          this.statisticsApiService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.statisticsStatisticsApi.created', { param: param.data.id }).toString();
