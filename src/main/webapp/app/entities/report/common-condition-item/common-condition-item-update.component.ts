      ...
      .then(values => {
        ...
        if (that.commonConditionItem.id) {
          this.commonConditionItemService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.reportCommonConditionItem.updated', { param: param.data.id }).toString();
          ...
          this.commonConditionItemService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.reportCommonConditionItem.created', { param: param.data.id }).toString();
