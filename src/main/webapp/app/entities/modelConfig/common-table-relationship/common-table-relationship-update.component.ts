      ...
      .then(values => {
        ...
        if (that.commonTableRelationship.id) {
          this.commonTableRelationshipService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.modelConfigCommonTableRelationship.updated', { param: param.data.id }).toString();
          ...
          this.commonTableRelationshipService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.modelConfigCommonTableRelationship.created', { param: param.data.id }).toString();
