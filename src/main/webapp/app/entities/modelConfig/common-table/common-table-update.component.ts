      ...
      .then(values => {
        ...
        if (this.commonTable.id) {
          this.commonTableService()
            ...
            .subscribe(param => {
              this.isSaving = false;
              const message = this.$t('blogApp.modelConfigCommonTable.updated', { param: param.data.id }).toString();
          ...
          this.commonTableService()
            ...
            .subscribe(param => {
              this.isSaving = false;
              const message = this.$t('blogApp.modelConfigCommonTable.created', { param: param.data.id }).toString();
