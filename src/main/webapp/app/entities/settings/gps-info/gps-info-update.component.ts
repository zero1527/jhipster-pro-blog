      ...
      .then(values => {
        ...
        if (that.gpsInfo.id) {
          this.gpsInfoService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.settingsGpsInfo.updated', { param: param.data.id }).toString();
          ...
          this.gpsInfoService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.settingsGpsInfo.created', { param: param.data.id }).toString();
