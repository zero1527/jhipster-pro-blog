      ...
      .then(values => {
        ...
        if (that.dataDictionary.id) {
          this.dataDictionaryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.settingsDataDictionary.updated', { param: param.data.id }).toString();
          ...
          this.dataDictionaryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('blogApp.settingsDataDictionary.created', { param: param.data.id }).toString();
