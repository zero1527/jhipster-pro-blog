...
import com.blog.myapp.domain.ApiPermission;
import com.blog.myapp.domain.enumeration.ApiPermissionType;
import com.blog.myapp.repository.ApiPermissionRepository;
import com.blog.myapp.security.SecurityUtils;
import com.blog.myapp.security.annotation.PermissionDefine;
import com.blog.myapp.service.dto.ApiPermissionDTO;
import com.blog.myapp.service.mapper.ApiPermissionMapper;
...
public class ApiPermissionService {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.blog.myapp.domain.ApiPermission.class.getName() + ".parent",
        com.blog.myapp.domain.ApiPermission.class.getName() + ".children" //,
        // com.blog.myapp.domain.ViewPermission.class.getName() + ".apiPermissions"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.blog.myapp.domain.ApiPermission.class.getName() + ".children")).clear();
    }
