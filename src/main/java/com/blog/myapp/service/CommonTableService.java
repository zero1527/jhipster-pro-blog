...
import com.blog.myapp.domain.CommonTable;
import com.blog.myapp.domain.CommonTableField;
...
import com.blog.myapp.repository.CommonTableFieldRepository;
import com.blog.myapp.repository.CommonTableRelationshipRepository;
...
import com.blog.myapp.service.mapper.CommonTableMapper;
...
public class CommonTableService {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.blog.myapp.domain.CommonTableField.class.getName() + ".commonTable",
        com.blog.myapp.domain.CommonTableRelationship.class.getName() + ".commonTable",
        com.blog.myapp.domain.User.class.getName() + ".commonTable",
        com.blog.myapp.domain.BusinessType.class.getName() + ".commonTable"
    );
