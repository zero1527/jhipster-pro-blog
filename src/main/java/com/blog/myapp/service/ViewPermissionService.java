...
public class ViewPermissionService {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        com.blog.myapp.domain.ViewPermission.class.getName() + ".parent",
        com.blog.myapp.domain.ApiPermission.class.getName() + ".viewPermissions",
        com.blog.myapp.domain.ViewPermission.class.getName() + ".children",
        com.blog.myapp.domain.Authority.class.getName() + ".viewPermission"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(com.blog.myapp.domain.ViewPermission.class.getName() + ".children")).clear();
    }
