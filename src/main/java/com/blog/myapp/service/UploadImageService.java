...
import com.blog.myapp.oss.model.BladeFile;
...
public class UploadImageService {
    ...
    private final List<String> relationCacheNames = Arrays.asList(com.blog.myapp.domain.User.class.getName() + ".uploadImage");
